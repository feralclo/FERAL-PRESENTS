...
### Phase 4 done ✅ (2026-04-29, including same-day polish pass 4.7) = release config consolidated; sales analytics shipped; tier templates work synchronously; what-if rebuilt as honest projection; mobile clean; API endpoint test-covered. **709/709 tests pass** (655 baseline + 54 new across sales-velocity, tier-templates, ticket-tmp-id, sales-timeline-route). `GroupManager.tsx` deleted. Production build green.
