...
| `src/components/admin/canvas/sections/ReleaseStrategyPanel.tsx` | ✅ | 2026-04-29 | Phase 4.1 — single source of truth for ticket release config. AdminButton + AdminBadge wrappers; sequential mode shows numbered position chips + (Phase 4.4) hedged time-to-unlock estimates. |
