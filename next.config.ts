...
const cspDirectives = [
  ...
  // Images: self + data URIs (QR codes, base64 logos) + Supabase Storage (rep media: avatars, banners, quest proofs, stories) + Mux thumbnails + Meta Pixel tracking
  `img-src 'self' data: blob: ${supabaseUrl} https://image.mux.com https://www.facebook.com`,
