...
import type { EventSettings, HomepageSettings } from "@/types/settings";
          ...
          <Card className="overflow-hidden bg-black">
            {device === "desktop" ? (
              <DesktopPreview
                ...
                focalX={focalX}
                focalY={focalY}
                line1={settings.hero_title_line1 || "YOUR BRAND"}
                line2={settings.hero_title_line2 || "STARTS HERE"}
                ctaText={settings.hero_cta_text || "EXPLORE"}
              />
            ) : (
              <MobilePreview
                imageUrl={imageUrl}
