        ...
        <div className="text-center max-w-sm rep-fade-in">
          ...
          <div className="mt-6 w-full max-w-[260px] mx-auto">
            ...
            <Button
              type="button"
              variant="outline"
              className="w-full h-12 gap-3 font-medium rounded-2xl"
          ...
          {error && (
            <div className="mt-4 w-full max-w-[280px] mx-auto rounded-xl bg-destructive/10 border border-destructive/20 px-4 py-3 text-sm text-destructive text-center">
              {error}
            </div>
          )}
        </div>
