...
export function MidnightCartSummary({
  ...
  return (
    ...
    >
      <div className="bg-foreground/[0.02] border border-foreground/[0.06] rounded-lg overflow-hidden">
        {/* Header */}
          ...
          {items.map((item, i) => (
            ...
            >
              <div className="flex items-baseline gap-2">
                ...
                <span className="font-[family-name:var(--font-mono)] text-[11px] text-muted-foreground shrink-0">
