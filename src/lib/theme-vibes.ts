...
export const THEME_VIBES: ThemeVibe[] = [
  ...
  },
  {
    id: "electric-blue",
    name: "Electric Blue",
    description: "Neon blue intensity — club nights, tech events, electric energy",
    mood: "Electric / Club / Neon",
    colors: {
      accent: "#00D4FF",
      background: "#030a10",
      card: "#081420",
    ...
    preview_gradient: "linear-gradient(135deg, #030a10, #081420, #030a10)",
    tags: ["Electric", "Club", "Neon"],
  },
  {
    id: "sunset-gold",
    name: "Sunset Gold",
    description: "Rich amber warmth — luxury events, golden hour, VIP energy",
    ...
    preview_gradient: "linear-gradient(135deg, #100a02, #1e1408, #100a02)",
    tags: ["Warm", "Luxury", "Golden"],
  },
  {
    id: "crimson-night",
    name: "Crimson Night",
    description: "Vivid red intensity — underground, warehouse, raw energy",
    ...
    preview_gradient: "linear-gradient(135deg, #0e0404, #1e0a0a, #0e0404)",
