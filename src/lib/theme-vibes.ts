...
export const THEME_VIBES: ThemeVibe[] = [
  ...
  },
  {
    id: "girly-pop-2",
    name: "Girly Pop 2",
    description: "Maximum pink — bubblegum overload, neon glow, zero subtlety",
    mood: "Bubblegum / Neon Pink / Party",
    colors: {
      accent: "#FF1493",
      background: "#1a0012",
      card: "#2a0a1e",
    ...
    preview_gradient: "linear-gradient(135deg, #1a0012, #3a0a28, #1a0012)",
    tags: ["Bubblegum", "Neon", "Party"],
  },
  {
    id: "barbie-dream",
    name: "Barbie Dream",
    description: "THE pink — glossy, bright, iconic Barbie energy. Not dark rose — real Barbie.",
    mood: "Barbie / Glossy / Iconic Pink",
    colors: {
      accent: "#E0218A",
      background: "#30112a",
      card: "#4a1c3d",
    ...
    preview_gradient: "linear-gradient(135deg, #30112a, #5a2248, #30112a)",
    tags: ["Barbie", "Glossy", "Iconic"],
  },
  {
    id: "neon-mint",
    name: "Neon Mint",
